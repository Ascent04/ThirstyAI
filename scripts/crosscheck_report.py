...
def main() -> None:
    ...
    md.append(
        ...
        "seit der Alias-Korrektur auch Mistral Large 2 - liegt ThirstyAIs "
        "mid-Schätzung beim 1,3- bis 2,3-fachen des EcoLogits-Werts, und der "
        "EcoLogits-Punktwert fällt in allen 12 Vergleichen (Energie, CO2, Wasser "
        "× short/long) in ThirstyAIs min–max-Spanne (siehe llama- und "
        "mistral-Zeilen unten). "
