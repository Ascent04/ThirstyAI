...
/**
 * Merge and validate already-parsed fact files. No filesystem access;
 * usable in browsers.
 */
export function buildFactTable(rawFiles: RawFactFile[]): FactTable {
